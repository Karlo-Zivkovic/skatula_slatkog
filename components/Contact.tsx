...
export default function Contact() {
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center px-4 md:px-6 bg-white">
          ...
          <div className="space-y-7 md:space-y-10">
            ...
            <div>
              ...
              <a
                ...
                className="text-brown hover:text-gold transition-colors text-lg break-all"
              >
