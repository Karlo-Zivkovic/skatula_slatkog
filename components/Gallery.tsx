          ...
          {categories.slice(0, 2).map((cat) => (
            <CategoryCard
              ...
              cat={{
                ...
                coverImagePosition: cat.coverImagePosition,
              }}
              count={cat.type === 'showcase' ? null : getCount(cat.slug)}
              t={t}
              height="h-64 md:h-80"
...
function CategoryCard({
  ...
  cat: { slug: string; name: string; description: string; gradient: string; coverImage: string; coverImagePosition?: string };
  count: number | null;
  ...
  return (
    ...
    >
      <Image
        ...
        style={{ objectPosition: cat.coverImagePosition ?? 'center' }}
      />
